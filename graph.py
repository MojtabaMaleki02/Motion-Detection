#Import the Dataframe from the motiondetectoropencv.py
from motiondetectoropencv import df
...
#Dataframe of time values is plotted on the browser using Bokeh plots
hover = HoverTool(tooltips=[("Start","@Start_string"),("End","@End_string")])
p.add_tools(hover)

q = p.quad(left="Start",right="End",bottom=0,top=1,color="red",source=cds)

output_file("GraphMotion.html")
show(p)